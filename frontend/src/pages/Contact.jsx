        ...
        <Container {...guestDefaultContainer}>
          ...
          >
            {isLaptop && (
              ...
              >
                <Typography
                  sx={{ fontSize: "1.25rem", mb: "2rem", textAlign: "justify" }}
                >
                  If you are a parent, student or teacher at a school that uses{" "}
                  <strong>InfoStudia</strong>, you can get support from your
                  Student Affairs Office.
                </Typography>
                <Typography sx={{ fontSize: "1.25rem", textAlign: "justify" }}>
                  If you are currently an <strong>InfoStudia</strong> user, or
                  if you are not using <strong>InfoStudia</strong> and would
                  like to speak with one of our team members, please email us
                  directly or come to our company for support.
                </Typography>
              </MotionBox>
            )}
            ...
            >
              ...
              >
                ...
                >
                  <MenuBookIcon sx={{ mr: 2 }} /> 227 Nguyễn Văn Cừ, Ward 4,
